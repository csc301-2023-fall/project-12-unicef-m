...
def clone():
    ...
    dashboard_filename = f'backend/zip/{extracted_folder_name}/dashboards/{dashboard_old_name_parsed}_{dashboard_id}.yaml'
    ...
    update_dashboard_uuids(charts, f'backend/zip/{extracted_folder_name}/charts/', dashboard_filename)

    csrf_token = get_csrf_token(access_token)
    import_new_dashboard(access_token, csrf_token, extracted_folder_name)

    delete_zip("backend/zip/")
